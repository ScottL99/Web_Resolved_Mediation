    ...
    <div className="flex flex-col my-10 p-5 z-0 overflow-hidden">
      ...
      <div className="flex flex-row">
        {servicesCards.map((card) => (
          <div
            key={card.id}
            className="flex flex-1 flex-col relative bg-orange p-5 hover:p-8 m-1 cursor-pointer group hover:bg-gray transition-all duration-700"
          >
            <div className="flex absolute -top-2 left-0  w-full opacity-0 bg-white group-hover:opacity-80  group-hover:-translate-y-full group-hover:h-[75vh] transition-all duration-500 ">
              <p className="flex justify-center items-center font-HN_Regular text-xl m-10 text-black ">
                {card.content1}
                <br></br>
                <br></br>
                {card.content2}
            ...
            <h5 className="text-white group-hover:text-stone-800 text-5xl font-HN_Medium justify-center mt-4">
              {card.title1} <br></br>
              {card.title2} <br></br>
              {card.title3}
            </h5>
