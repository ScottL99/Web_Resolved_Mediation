...
const WhereWeAre = () => {
  return (
    <section className="mx-4 sm:mx-12 lg:mx-20">
      <motion.h1
        className="mt-10 lg:mt-20 ml-8 sm:ml-2 sm:p-5 text-[2.5em] sm:text-[4rem] lg:text-[7rem] xl:text-[9.5rem] 
      ...
      <div className="flex flex-1 flex-col lg:flex-row mt-6 py-5 px-8 lg:px-16 bg-gray items-start sm:items-center justify-around tracking-tight  ">
        <div className="flex lg:w-[59%] flex-col justify-center">
          {whereWeAreContent1.map((text, index) => (
            <h5
              key={index}
              className="text-xl sm:text-3xl xl:text-5xl xxl:text-6xl  font-HN_Bold tracking-tight hover:scale-105 transition-all hover:text-charcoal"
            >
              {text.content}
              <br />
            </h5>
